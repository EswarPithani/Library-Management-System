    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        <h1>Contact Us</h1>
                        <p>Librarian</p>
                        <p>NIT, Andhra Pradesh</p>
                        <p>Tadepalligudem</p>
                        <p>India</p>
                        <p><b>Email:</b>rollno@student.nitandhra.ac.in</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2025 copyright all right reserved<br /></p>
            </div>
        </div>
    )
}
